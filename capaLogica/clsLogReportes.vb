...
Public Class clsLogReportes
    ...
    Public Function ListarEstudiantesPorTipo(tipoEstudiante As String) As DataTable
        Dim objDatos As New ClsDatReportes()
        Return objDatos.ObtenerEstudiantesPorTipo(tipoEstudiante)
    End Function
